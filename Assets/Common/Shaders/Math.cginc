...
float2 EaseInQuad(float2 start, float2 end, float value)
{
    end -= start;
    return end * value * value + start;
}
float3 EaseInQuad(float3 start, float3 end, float value)
{
    end -= start;
    return end * value * value + start;
}
...
float2 EaseOutQuad(float2 start, float2 end, float value)
{
    end -= start;
    return -end * value * (value - 2) + start;
}
float3 EaseOutQuad(float3 start, float3 end, float value)
{
    end -= start;
    return -end * value * (value - 2) + start;
}
...
float CubicInOut(float t, float start, float end, float d)
{
    if ((t /= d / 2) < 1)
